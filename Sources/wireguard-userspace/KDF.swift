...
internal func wgKDF(key:Key, data:borrowing [UInt8], returning:(Result32)) throws -> Result32 {
...
internal func wgKDF(key:Key, data:borrowing [UInt8], returning:(Result32, Result32)) throws -> (Result32, Result32) {
